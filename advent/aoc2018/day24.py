class Group:
    def __init__(self, unit_count: int, unit_hp: int, unit_dmg: int, initiative: int, attack_type: str,
                 weaknesses: list, immunities: list, army_name: str, group_num: int):
    ...
    def __repr__(self):
        return str((self.unit_count, self.unit_hp, self.unit_dmg, self.initiative, self.attack_type,
