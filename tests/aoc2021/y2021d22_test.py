...
import aoc_cj.aoc2021.day22 as d
...
CUBOID_1 = d.Cuboid(0, 1, 0, 0, 0, 0)
CUBOID_2 = d.Cuboid(0, 2, 0, 0, 0, 0)
CUBOID_3 = d.Cuboid(0, 1, 0, 1, 0, 0)
CUBOID_4 = d.Cuboid(0, 1, 0, 1, 0, 1)

# C6 is a 1x1x1 cube inside of C5, a 3x3x3 cube
CUBOID_5 = d.Cuboid(0, 2, 0, 2, 0, 2)
CUBOID_6 = d.Cuboid(1, 1, 1, 1, 1, 1)

# non-cube shaped cuboids
CUBOID_7 = d.Cuboid(0, 1, 0, 1, 0, 2)
CUBOID_8 = d.Cuboid(0, 2, 0, 2, 0, 3)

# 11 is intersection of 9 & 10
CUBOID_9 = d.Cuboid(0, 3, 1, 2, 1, 2)
CUBOID_10 = d.Cuboid(2, 4, 0, 1, 0, 1)
CUBOID_11 = d.Cuboid(2, 3, 1, 1, 1, 1)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (CUBOID_0, CUBOID_3, CUBOID_0),
        (CUBOID_0, CUBOID_4, CUBOID_0),
        (CUBOID_0, CUBOID_5, CUBOID_0),
        (CUBOID_0, CUBOID_6, None),
        (CUBOID_0, CUBOID_7, CUBOID_0),
        (CUBOID_0, CUBOID_8, CUBOID_0),
        (CUBOID_0, CUBOID_9, None),
        (CUBOID_0, CUBOID_10, None),
        (CUBOID_0, CUBOID_11, None),
        (CUBOID_1, CUBOID_2, CUBOID_1),
        (CUBOID_5, CUBOID_6, CUBOID_6),
        (CUBOID_6, CUBOID_5, CUBOID_6),
        (CUBOID_7, CUBOID_8, CUBOID_7),
        (CUBOID_8, CUBOID_7, CUBOID_7),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (CUBOID_1, CUBOID_0, 1),
        (CUBOID_2, CUBOID_0, 2),
        (CUBOID_5, CUBOID_6, CUBOID_5.volume() - CUBOID_6.volume()),
        (CUBOID_6, CUBOID_5, 0),
